...
public class HoodZeroingSequence extends SequentialCommandGroup {
    ...
    public HoodZeroingSequence(Hood hood, 
    double output,
    MedianFilter filter,
    ...
    double timeThreshold
        ...
        addCommands(new HoodZeroingHighVel(hood, output, filter, highVelocityThreshold), 
        new HoodZeroingHardstop(hood, output, filter, lowVelocityThreshold, timeThreshold));
    }
}
